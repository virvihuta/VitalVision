...
const translations = {
  en: {
    ...
    personalNumberPlaceholder: "e.g. A12345678A",
    personalNumberInvalid: "Invalid personal number format",
    bodyPart: "Body Part",
    bpChest: "Chest",
    bpAbdomen: "Abdomen",
    bpHeadBrain: "Head / Brain",
    bpSpine: "Spine",
    bpPelvis: "Pelvis",
    bpUpperExtremities: "Extremities (Upper)",
    bpLowerExtremities: "Extremities (Lower)",
    bpNeck: "Neck",
    bpCardiac: "Cardiac",
    bpFullBody: "Full Body",
  ...
  sq: {
    ...
    personalNumberPlaceholder: "p.sh. A12345678A",
    personalNumberInvalid: "Format i pavlefshëm i numrit personal",
    bodyPart: "Zona e Skanimit",
    bpChest: "Gjoks",
    bpAbdomen: "Abdomen",
    bpHeadBrain: "Koka / Truri",
    bpSpine: "Shtylla Kurrizore",
    bpPelvis: "Pelvis",
    bpUpperExtremities: "Gjymtyrët (Sipërme)",
    bpLowerExtremities: "Gjymtyrët (Poshtme)",
    bpNeck: "Qafa",
    bpCardiac: "Kardiak",
    bpFullBody: "I Plotë",
